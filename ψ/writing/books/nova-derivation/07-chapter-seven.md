...
-   [ ] **Genesis Hash & Batcher Inbox Verification**: ตรวจสอบป้องกันกับดักการใช้ Batcher Inbox ซ้ำ (Reused Batcher Inbox) โดยตรวจสอบว่าแฮช L2 Genesis Block (`0x1c9445c6...`) ตรงกับแฮชของบล็อก batches ที่อยู่บน L1 ภายหลังจุดบล็อกเริ่มต้นประมวลผล L1 (`genesis.l1.number` = `11098766`) และทดสอบรันโหนดติดตามตรวจสอบว่า `safe_l2` สามารถขยับสูงตามจริงเพื่อยืนยันว่า L1 Derivation ไม่ชะงักค้างคาอยู่ที่ 0
